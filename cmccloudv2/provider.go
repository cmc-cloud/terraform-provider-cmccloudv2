...
func Provider() terraform.ResourceProvider {
	p := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"cmccloudv2_kubernetesv2_nodegroup_gpu_config": resourceKubernetesv2NodeGroupGpuConfig(),
			...
			"cmccloudv2_rds_cluster":          resourceRdsCluster(),
			"cmccloudv2_rds_cluster_backup":   resourceRdsClusterBackup(),
			...
			"cmccloudv2_keyvault":          resourceKeyVault(),
			"cmccloudv2_apigateway":        resourceApiGateway(),
			"cmccloudv2_apigateway_backup": resourceApiGatewayBackup(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"cmccloudv2_flavor_dbproxy":              datasourceFlavorForDBProxy(),
			"cmccloudv2_flavor_k8s":                  datasourceFlavorForK8s(),
			"cmccloudv2_flavor_kafka":                datasourceFlavorForKafka(),
			"cmccloudv2_flavor_elb":                  datasourceFlavorForELB(),
			"cmccloudv2_rds_cluster_flavor":          datasourceFlavorForRdsCluster(),
			"cmccloudv2_opensearch_flavor":           datasourceFlavorForOpenSearchInstance(),
			"cmccloudv2_opensearch_dashboard_flavor": datasourceFlavorForOpenSearchDashboard(),
